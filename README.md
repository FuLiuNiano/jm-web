...
- **完整阅读器**：连续滚动、正序/RTL 单页、点击翻页四种模式；前后预解码、章节跳转、进度恢复、页码、亮度、Wake Lock、1–4x 缩放、工具栏自动隐藏、点击区域、内存优化和解码并发设置；阅读中可热切换主题、图片线路和预加载。
...
git commit -m "feat: improve reader loading"
